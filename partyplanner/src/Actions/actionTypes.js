...
export const FETCH_USER_ID_START = "FETCH_USER_ID_START";
...
export const DELETE_TODO_LIST_ITEM_START = "DELETE_TODO_LIST_ITEM_START";
export const DELETE_TODO_LIST_ITEM_SUCCESS = "DELETE_TODO_LIST_ITEM_SUCCESS";
export const DELETE_TODO_LIST_ITEM_FAILURE = "DELETE_TODO_LIST_ITEM_FAILURE";
export const UPDATE_TODO_LIST_ITEM_START = "UPDATE_TODO_LIST_ITEM_START";
export const UPDATE_TODO_LIST_ITEM_SUCCESS = "UPDATE_TODO_LIST_ITEM_SUCCESS";
export const UPDATE_TODO_LIST_ITEM_FAILURE = "UPDATE_TODO_LIST_ITEM_FAILURE";
export const ADD_TODO_LIST_ITEM_START = "ADD_TODO_LIST_ITEM_START";
export const ADD_TODO_LIST_ITEM_SUCCESS = "ADD_TODO_LIST_ITEM_SUCCESS";
export const ADD_TODO_LIST_ITEM_FAILURE = "ADD_TODO_LIST_ITEM_FAILURE";
export const ADD_TODO_LIST_ID_START = "ADD_TODO_LIST_ID_START";
export const ADD_TODO_LIST_ID_SUCCESS = "ADD_TODO_LIST_ID_SUCCESS";
export const ADD_TODO_LIST_ID_FAILURE = "ADD_TODO_LIST_ID_FAILURE";
export const START_TODO_LIST_EDIT = "START_TODO_LIST_EDIT";
export const STOP_TODO_LIST_EDIT = "STOP_TODO_LIST_EDIT";
